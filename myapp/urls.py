...
urlpatterns = [
    ...
    path('prediction/', views.analyze_comments, name='prediction'),
    
    path('display_hotels/', views.display_hotels, name='display_hotels'),
    path('display_HotelReview/', views.display_HotelReview, name='display_HotelReview'),
    path('analyze_review_view/', views.analyze_review_view, name='analyze_review_view'),
